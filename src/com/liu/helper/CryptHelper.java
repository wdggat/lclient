...
public class CryptHelper {
	private static final String TAG = CryptHelper.class.getCanonicalName();
	...
	private static byte[] aesDecrypt(byte[] src, String key) {
		try {
			...
			Log.e(TAG, "Exception when decrypt text: " + src + ", KEY: " + key, ex);
			return null;
		}
	}
	...
	private static byte[] aesEncrypt(byte[] src, String key) {
		try {
			...
			Log.e(TAG, "Exception when encrypt text: " + src + ", KEY: "
					+ key);
			return null;
		}
	}
